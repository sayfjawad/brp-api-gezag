...
Functionaliteit: 1.3 - is naar buitenland geëmigreerd geweest
  ...
  Een kind kan het gezag uit het buitenland hebben meegenomen wanneer hij naar het buitenland geëmigreerd is geweest of tijdelijk
  in het buitenland heeft gewoond. Dit gezag kan niet betrouwbaar worden bepaald, omdat regelgeving uit het buitenland mogelijk
  niet bekend is bij de Nederlandse overheid.
