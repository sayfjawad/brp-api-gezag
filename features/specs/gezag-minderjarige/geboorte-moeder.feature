...
Functionaliteit: Wie is de geboortemoeder van het kind?
  ...
  Bij erkenning na 1-1-2023 geen probleem want dan hebben de ouders beide gezag. Bij erkenning voor 1-1-2023 is dit wel een probleem want dan heeft alleen de geboortemoeder automatisch gezag.
  ...
  Regel: een kind geboren voor 01-01-2023
    ...
    Scenario: Voor een kind waarvan beide ouders de geslachtsaanduiding vrouw hebben en een ouder een overeenkomstige geslachtsnaam, kan worden bepaald wie gezag heeft er is sprake van EenhoofdigOuderlijkGezag
      Gegeven persoon 'Marijn'
      * heeft de volgende gegevens    
      | geslachtsaanduiding (04.10)     | geslachtsnaam (02.40) |                             
      | V                               | Visser                |    
      Gegeven persoon 'Noah'
      * heeft de volgende gegevens    
      | geslachtsaanduiding (04.10)     |
