...
Functionaliteit: Tg021 - Doornenbal-Doodewaard
  ...
  Achtergrond:
    ...
    | datum huwelijkssluiting/aangaan geregistreerd partnerschap (06.10)  | 20100601   |
    | plaats huwelijkssluiting/aangaan geregistreerd partnerschap (06.20) | 0518       |
    | land huwelijkssluiting/aangaan geregistreerd partnerschap (06.30)   | 6030       |
    ...
    | aktenummer (81.20)                                 | 1AA0101    |
    | ingangsdatum geldigheid (85.10)                    | 20060610   |
    | datum ingang familierechtelijke betrekking (62.10) | 20060610   |
    En de persoon heeft een ouder '2' met de volgende gegevens
    | naam                            | waarde   |
    | aktenummer (81.20)              | 1AA0101  |
    | ingangsdatum geldigheid (85.10) | 20060610 |
