...
public class OuderOfPartnerOverledenOfOnbevoegdTotGezag implements GezagVraag {
    ...
    /**
     * Beslissingstabel met drie inputs: (ouder1 of ouder2?), bool 'ouderOverledenOfOnbevoegd',
     * bool 'nietOuderOverledenOfOnbevoegd'
     */
    ...
    /**
     * Als we 'Ja_beiden' hebben, checken we tokens (bv. 'cc', 'cm', 'mm', 'oo', etc.) en geven
     * een meer specifieke antwoord-string terug.
     */
    ...
    public GezagVraagResult perform(final GezagsBepaling gezagsBepaling) {
        ...
        if (V4B_1_JA_BEIDEN.equals(answer)) {
            ...
            final var key2 = "" + isOuderOverledenOfOnbevoegdToken + isNietOuderOverledenOfOnbevoegdToken;
