...
public class IsErSprakeVanEenRecenteGebeurtenisFunction implements GezagVraagFunction {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(IsErSprakeVanEenRecenteGebeurtenisFunction.class);
    ...
    private boolean nuGehuwdOudersNaGeldigheidsdatum(final Persoonslijst plOuder1,
        ...
        final var hopOuder1Actueel = hopListOuder1.get(hopListOuder1.size() - 1).getDatumVoltrokken();
        final var hopOuder2Actueel = hopListOuder2.get(hopListOuder2.size() - 1).getDatumVoltrokken();
