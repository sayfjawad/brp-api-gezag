...
public class OudersOverledenOfOnbevoegdTotGezag extends GezagVraag {
    ...
    public void perform() {
        ...
        boolean ouder1OverledenOfOnbevoegd = gezagsBepaling.getPlOuder1().isOverledenOfOnbevoegd();
        boolean ouder2OverledenOfOnbevoegd = gezagsBepaling.getPlOuder2().isOverledenOfOnbevoegd();
