...
public class Categorie {
    ...
    public static final String VERBLIJFPLAATS = "08";
    public static final String KIND = "09";
    public static final String GEZAGSVERHOUDING = "11";
    ...
    public static final String GESCHIEDENIS_NATIONALITEIT = "54";
    public static final String GESCHIEDENIS_HUWELIJK_OF_PARTNERSCHAP = "55";
    public static final String GESCHIEDENIS_INSCHRIJVING = "57";
    public static final String GESCHIEDENIS_VERBLIJFPLAATS = "58";
    public static final String GESCHIEDENIS_KIND = "59";
