...
import nl.rijksoverheid.mev.gezagsmodule.domain.gezagvraag.OudersOverledenOfOnbevoegdTotGezag;
...
class OudersOverledenOfOnbevoegdTotGezagFunctionTest {
    ...
    private OudersOverledenOfOnbevoegdTotGezagFunction classUnderTest;
    ...
    public void setup() {
        ...
        classUnderTest = new OudersOverledenOfOnbevoegdTotGezagFunction();
    }
