...
import nl.rijksoverheid.mev.gezagsmodule.domain.gezagvraag.IsNaarBuitenlandGeemigreerdGeweest;
...
class IsNaarBuitenlandGeemigreerdGeweestFunctionTest {
    ...
    private IsNaarBuitenlandGeemigreerdGeweestFunction classUnderTest;
    ...
    public void setup() {
        ...
        classUnderTest = new IsNaarBuitenlandGeemigreerdGeweestFunction();
    }
