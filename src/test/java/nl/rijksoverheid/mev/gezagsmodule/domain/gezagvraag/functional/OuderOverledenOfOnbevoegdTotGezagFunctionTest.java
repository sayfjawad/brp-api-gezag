...
import nl.rijksoverheid.mev.gezagsmodule.domain.gezagvraag.OuderOverledenOfOnbevoegdTotGezag;
...
class OuderOverledenOfOnbevoegdTotGezagFunctionTest {
    ...
    private OuderOverledenOfOnbevoegdTotGezagFunction classUnderTest;
    ...
    public void setup() {
        ...
        classUnderTest = new OuderOverledenOfOnbevoegdTotGezagFunction();
    }
