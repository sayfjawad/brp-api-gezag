...
import nl.rijksoverheid.mev.gezagsmodule.domain.gezagvraag.HoeveelJuridischeOudersHeeftMinderjarige;
...
class HoeveelJuridischeOudersHeeftMinderjarigeFunctionTest {
    ...
    private HoeveelJuridischeOudersHeeftMinderjarigeFunction classUnderTest;
    ...
    public void setup() {
        ...
        classUnderTest = new HoeveelJuridischeOudersHeeftMinderjarigeFunction();
    }
